...
const Settings = () => {
  ...
  const { currency, shippingCost, taxRate, paymentMethods } = useSelector(
        ...
        <Label>
          ...
          >
            {paymentMethods.paypal
              ? texts.settings.paypalActive
              : texts.settings.paypalInactive}
          </ToggleButton>
        </Label>
        ...
        <Label>
          ...
          >
            {paymentMethods.stripe
              ? texts.settings.stripeActive
              : texts.settings.stripeInactive}
          </ToggleButton>
        </Label>
